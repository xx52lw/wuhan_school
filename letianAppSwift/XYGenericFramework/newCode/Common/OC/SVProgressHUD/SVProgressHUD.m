...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        _imageViewSize = CGSizeMake(70, 70);
...
- (void)updateHUDFrame {
    ...
    self.hudView.bounds = CGRectMake(0.0f, 0.0f, MAX(self.minimumSize.width, hudWidth) + 30, MAX(self.minimumSize.height, hudHeight));
#if __IPHONE_OS_VERSION_MAX_ALLOWED >= 80000
...
//            strongSelf.imageView.tintColor = tintColor;
            tintedImage = [image imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
...
//    self.hudVibrancyView.effect = [UIVibrancyEffect effectForBlurEffect:blurEffect];
    self.hudVibrancyView.backgroundColor = [UIColor colorWithRed:112.0/255.0 green:112.0/255.0 blue:112.0/255.0 alpha:1.0];
}
