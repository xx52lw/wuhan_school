//
//  HotestDiscountTableViewCell.swift
//  XYGenericFramework
//
...
class HotestDiscountTableViewCell: UITableViewCell {

   static var hotestDiscountCellHeight = cmSizeFloat(30+40+26+21) + cmSingleLineHeight(fontSize: cmSystemFontWithSize(12))*2 + cmSingleLineHeight(fontSize: cmSystemFontWithSize(16))
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        if !self.isEqual(nil) {
          ...
          let  seperateLine = XYCommonViews.creatCommonSeperateLine(pointY: HotestDiscountTableViewCell.hotestDiscountCellHeight - CGFloat(1))
