...
class ShopCartTableViewCell: UITableViewCell {
    ...
    static var ShopCartCellHeight = cmSizeFloat(70)
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        if !self.isEqual(nil) {
            ...
            goodsInfoLabel = UILabel(frame: CGRect(x: 0, y: (ShopCartTableViewCell.ShopCartCellHeight - cmSingleLineHeight(fontSize: cmSystemFontWithSize(14)) - cmSingleLineHeight(fontSize: cmSystemFontWithSize(12)) - wordSpaceHeight)/2, width: cellWidth/2, height: cmSingleLineHeight(fontSize: cmSystemFontWithSize(14))))
            ...
            otherInfoLabel = UILabel(frame: CGRect(x: 0, y: goodsInfoLabel.bottom + wordSpaceHeight, width: (SCREEN_WIDTH  - toside*2)/2, height: cmSingleLineHeight(fontSize: cmSystemFontWithSize(12))))
            otherInfoLabel.font = cmSystemFontWithSize(12)
            otherInfoLabel.textColor = MAIN_GRAY
            otherInfoLabel.textAlignment = .left
            self.addSubview(otherInfoLabel)
            
            
            addBtn = UIButton(frame: CGRect(x: cellWidth - addBtnSize, y: (ShopCartTableViewCell.ShopCartCellHeight - addBtnSize)/2, width: addBtnSize, height: addBtnSize))
    ...
    func setModel(model:ShopcartModel,index:Int){
        ...
        cellShopcartModel = model
        goodsInfoLabel.text = model.goodsNameStr
        otherInfoLabel.text = model.otherInfoStr
