...
class CatsDetailTableViewCell: UITableViewCell {

    static let cellHeight =  cmSizeFloat(15*2) + cmSingleLineHeight(fontSize: cmBoldSystemFontWithSize(14)) + cmSizeFloat(12) + cmSizeFloat(5*4 + 0.5) + cmSingleLineHeight(fontSize: cmSystemFontWithSize(11)) * 3 + cmSizeFloat(4)
    ...
    func setModel(model:CatsCellModel){
