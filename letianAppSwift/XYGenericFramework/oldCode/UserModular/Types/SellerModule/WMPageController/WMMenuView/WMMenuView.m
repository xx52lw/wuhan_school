...
#import "WMMenuView.h"
#import "XYGenericFramework-Swift.h"
...
- (void)addItems {
    ...
    for (int i = 0; i < self.titlesCount; i++) {
        ...
        UIView *seperateLine = [[UIView alloc] initWithFrame:CGRectMake(0, item.frame.size.height-1,[UIScreen mainScreen].bounds.size.width , 1)];
        seperateLine.backgroundColor =  [UIColor colorWithRed:0.8 green:0.8 blue:0.8 alpha:1];
        [self.scrollView addSubview:seperateLine];
        }
        
//        UIView *seperateLine = [[UIView alloc] initWithFrame:CGRectMake((i + 1)*[UIScreen mainScreen].bounds.size.width/4, item.frame.origin.y+4,1 , item.frame.size.height - 8)];
//        seperateLine.backgroundColor =  [UIColor colorWithRed:0.8 green:0.8 blue:0.8 alpha:1];
//        [self.scrollView addSubview:seperateLine];
