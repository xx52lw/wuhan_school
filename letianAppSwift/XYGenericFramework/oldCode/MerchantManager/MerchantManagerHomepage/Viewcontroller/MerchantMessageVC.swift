...
class MerchantMessageVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    var messageListModel:MerchantMessageListModel!
    var service:MerchantMessageListService = MerchantMessageListService()
    override func viewDidLoad() {
        super.viewDidLoad()
        self.view.backgroundColor = .white
        creatNavTopView()
        self.service.getMerchantMessageListRequest(target: self)
    ...
    func creatMainTabView(){
        ...
        mainTabView.register(MerchantMessageTabcell.self, forCellReuseIdentifier: "MerchantMessageTabcell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var cell = tableView.dequeueReusableCell(withIdentifier: "MerchantMessageTabcell")
        if cell == nil {
            cell = MerchantMessageTabcell(style: UITableViewCellStyle.default, reuseIdentifier: "MerchantMessageTabcell")
        }
        if let targetCell = cell as? MerchantMessageTabcell{
