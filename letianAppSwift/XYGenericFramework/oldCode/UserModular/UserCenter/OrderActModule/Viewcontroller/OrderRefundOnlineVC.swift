...
class OrderRefundOnlineVC: UIViewController,UITableViewDelegate,UITableViewDataSource,UITextViewDelegate {
    ...
    func createTableviewFooter(){
        ...
        let placeholderText = "请输入申请退款原因，2-100字以内"
    ...
    @objc func submitBtnAct(){
        ...
        service.applicationForRefundRequest(userOrderID: self.orderID, content: cancelReasonText, successAct: {
