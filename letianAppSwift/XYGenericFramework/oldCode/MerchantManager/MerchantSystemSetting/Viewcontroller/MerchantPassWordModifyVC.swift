//
//  MerchantPassWordModifyVC.swift
//  XYGenericFramework
//
...
class MerchantPassWordModifyVC: UIViewController,UITextFieldDelegate {
    ...
    var service:MerchantSystemSettingService = MerchantSystemSettingService()
    ...
    @objc func submitModifyBtnAct(sender:UIButton) {
        ...
        service.updateMerchantPassWordRequest(paramsDict: paramsDict, successAct: { [weak self] in
